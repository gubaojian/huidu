...
public class CleanContentSourceSignInHeader  extends ContentCommand {
	 ...
	 * 根据日志结尾删除，无关信息
	 * */
	private static  String CLEAN_HEADER_REGEX = "转载请注明";
	static{
		CLEAN_HEADER_REGEX +="|本文链接地址";
		CLEAN_HEADER_REGEX +="|本文地址";
		CLEAN_HEADER_REGEX +="|原文地址";
		CLEAN_HEADER_REGEX +="|上篇";
		CLEAN_HEADER_REGEX +="|发表于";
		CLEAN_HEADER_REGEX +="|Author$";
		CLEAN_HEADER_REGEX +="|以下原文转载自";  //http://127.0.0.1:8080/admin/me/articleDetail.html?id=344&source=true
	}
	...
	protected void clean(ContentContext context) {
		    ...
		    Elements matchElements = document.getElementsMatchingOwnText(CLEAN_HEADER_PATTERN);
