...
LOCAL_DIR="../admin/target/huidu/."
REMOTE_DIR="/var/lib/tomcat7/webapps/huidu/"
BACK_UP_DIR="/var/lib/tomcat7/backup/huidu/"
TOMCAT_WORK_DIR="/var/lib/tomcat7/work/"
STATUS_CHECK_PATH="/huidu/index.jsp"
RAS_PRIVATE_KEY="ext/aliyun_rsa"
LOG_FILE="/var/lib/tomcat7/logs/catalina.out"
LOG4j_FILE="/var/log/huidu/huidu.log"
CURL_ONE="127.0.0.1:8080/huiduservice/index.html"
