package net.java.efurture.duke.extractor.site.feed;
...
public class FeedClient {
	...
	public static SyndFeed grapFeedUrl(String url){
		return grapFeedUrl(url, null);
	}
	
	public static SyndFeed grapFeedUrl(String url, Map<Object,Object> context){
